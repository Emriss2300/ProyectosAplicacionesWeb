...
<head>
    ...
    <style>
        ...
        body {
            ...
            height: 100vh;
            background-image: url('vista/imagenes/imagenrancagua.jpg');
...
<body>
    <div class="content-box">
        ...
        <!-- Se crea un formulario que enviará los datos ingresados a la página "vista/pagina.php" utilizando el método POST -->
        <form action="vista/pagina.php" method="POST">
            ...
            <!-- Se muestra una casilla de verificación para indicar el interés en la información de la página, con el id "interes". Esta permitirá condicionar el carrusel en la vista/pagina.php -->

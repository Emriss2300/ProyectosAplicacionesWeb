...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-07-2023 a las 03:21:26
...
(13, '2023-07-19', 'hola', 'La investigación que desarrolla la Fiscalía Metropolitana Centro Norte por el delito de cohecho presuntamente cometido por el alcalde de Recoleta, Daniel Jadue (PC), al mando de la Asociación Chilena de Farmacias Populares (Achifarp), contiene declaraciones, conversaciones de WhatsApp y fotografías como antecedentes.', 'images/AA1e5gK4.jpg'),
...
(5, 'Sus tres dirigentes artísticos, Francisco Núñez, Lucila Ortiz, Fernanda Núñez, hemos trabajado incansablemente para el desarrollo cultural de cientos de niños y jóvenes de la región, apoyando a la cultura tradicional.');
